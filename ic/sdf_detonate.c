...
double mass_in_msol;
double maxmass;
double mass,tmass,r,rr,rmax,e1,e2,e3,x,y,z,xp,yp,zp,m,b,rho,energy,rhomin;
float rmin,pos;
int nexp;
double mni,mcore;
...
int main(int argc, char **argv[])
{
    ...
    printf("Position of bomb: ");
    scanf("%f",&pos);
    printf("Placing bomb @ %f,0,0\n",pos);
    printf("Size of bomb: ");
    scanf("%f",&rmin);
    ...
    for(i=0;i<nobj;i++)
    {
        ...
        r = sqrt(pow(body[i].x-pos,2.0)+pow(body[i].y,2.0)+pow(body[i].z,2.0));
