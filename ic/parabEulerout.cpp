...
int main()
{
	...
	ofstream pout("parabout.csv");
	pout << "t,x1,x2,y1,y2,vx1,vx2,vy1,vy2,E" << endl;
...
//			printf("%3.2f:\t x2=%3.2ecm \t y2=%3.2ecm \t vx2=%3.2ekm/s \t vy2=%3.2ekm/s\n",m2,r2[0]*6.955e10,r2[1]*6.955e10,v2[0]*6.955e10*1e-5,v2[1]*6.955e10*1e-5);
			...
			pout << t << "," 
				<< (r1[0]-cm[0])*1 << "," << (r2[0]-cm[0])*1 << "," 
				<< (r1[1]-cm[1])*1 << "," << (r2[1]-cm[1])*1 << "," 
				<< fabs(v1[0]-cv[0])*6.955e10*1e-5 << "," << fabs(v2[0]-cv[0])*6.955e10*1e-5 << "," 
				<< fabs(v1[1]-cv[1])*6.955e10*1e-5 << "," << fabs(v2[1]-cv[1])*6.955e10*1e-5 << "," 
				<< fabs(TE1) << endl;
			//eout << i << "," << TE1 << endl;
		}
