...
double maxmass;
double mass,tmass,r,rmax,f,fm13,f65;
int nsub;
...
int usage()
{
	printf("\t Creates new file with rescaled particle masses for a chosen total mass.\n");
    printf("\t ((Must isothermalize the result!))\n");
	printf("\t Usage: [required] {optional}\n");
	printf("\t sdf_remass [input file] [desired mass]\n");
	return 0;
}
